...
C
 2020 CURPOS=1
      CALL NXTCHR(CH,TY)
      IF(CH.EQ.5637144576.OR.CH.EQ.7918845952.OR.CH.EQ.4429185024.OR.
     1 CH.EQ.KEOC)GOTO 4200
C
...
C
 2040 IF(CH.EQ.4294967296)GOTO 2050
      IF((CH.EQ.7918845952.OR.CH.EQ.4429185024.OR.CH.EQ.KEOC).AND
     1 .LABEL(1).EQ.0)
     1  GOTO 4200
...
C
 2100 IF(INPBUF(CURPOS-3).EQ.8724152320.AND.INPBUF(CURPOS-2).EQ.
     1 9395240960)GOTO 2090
...
C
 ...
 3310 IF(CH.EQ.4294967296.OR.CH.EQ.7918845952.OR.CH.EQ.4429185024.OR.
     1 CH.EQ.KEOC)GOTO 4200
...
C
 ...
 3352 CALL NXTCHR(CH,TY)
      ...
      IF(CH.NE.4294967296.AND.CH.NE.7918845952.AND.CH.NE.4429185024.AND
     1 .CH.NE.KEOC)GOTO 3630
      GOTO 3370
...
C
 ...
 3430 CALL NXTCHR(CH,TY)
      ...
      CALL PACK(LABEL(1),CH)
      GOTO 3430
 3440 IF(CH.NE.4294967296.AND.CH.NE.7918845952.AND.CH.NE.4429185024.AND
     1 .CH.NE.KEOC)GOTO 3630
...
C
 ...
 3520 CALL NXTCHR(CH,TY)
      ...
      CALL PACK(GO2LBL(1),CH)
      GOTO 3520
 3530 IF(CH.NE.4294967296.AND.CH.NE.7918845952.AND.CH.NE.4429185024.AND
     1 .CH.NE.KEOC)GOTO 3630
      GOTO 4200
C
...
C
 ...
 3616 I=J
      ...
      IF(CH.EQ.7918845952.OR.CH.EQ.4294967296.OR.CH.EQ.4429185024.OR.
     1 CH.EQ.KEOC)GOTO 3619
 3618 FLAGMC=0
      GOTO 3630
...
C
 ...
 3677 CALL NXTCHR(CH,TY)
      ...
      IF(CH.NE.5905580032.AND.CH.NE.4294967296.AND.CH.NE.4429185024.AND
     1 .CH.NE.7918845952.AND.
...
C
  300 ARGTY=37
     ...
     1  INPBUF(ARGB+2).EQ.5234491392.AND.ARGE-ARGB.EQ.2)RETURN
      IF(INPBUF(ARGB).NE.5368709120.OR.INPBUF(ARGE).NE.5502926848
     1 )GOTO 800
...
C
  500 IF(ARGE-ARGB.LT.5)GOTO 850
      ...
      IF(INPBUF(ARGB+3).NE.5771362304.AND.INPBUF(ARGB+3).NE.
     1 6039797760)GOTO 850
      ARGTY=0

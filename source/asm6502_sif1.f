...
C
     ...
     1FORM='UNFORMATTED',RECL=40,ACCESS='DIRECT',STATUS='REPLACE')
      IF (IAND(OPTION,OPTOU).NE.0)OPEN (OUUNIT,FILE=OBJNAM,FOR
     1 M='FORMATTED',STATUS='REPLACE')
      CALL DOPASS
...
1230  IF (HISYM.EQ.0)GOTO 1330
      DO 1240 I=1,HISYM
         IF (IAND(SYMBOL(3,I),1).EQ.0.AND.SYMBOL(1,I).NE.
     1 8724152320)GOTO 1250
1240  CONTINUE
      GOTO 1330
1250  N=3*(LOWID/12)
      IF (N.GT.27)N=27
...
1290  LOBUF(J)=BLANK
      CALL LIST
      J=1
1300  IF (IAND(SYMBOL(3,I),1).NE.0.OR.SYMBOL(1,I).EQ.872415232
     1 0)GOTO 1320
      IF (J.LT.N)GOTO 1310
      CALL LIST
      GOTO 1280
...
1060  CURPOS=1
      CALL NXTCHR(CH,TY)
      IF (CH.EQ.5637144576.OR.CH.EQ.7918845952.OR.CH.EQ.
     1 4429185024.OR.CH.EQ.KEOC)GOTO 2700
C
...
1090  IF (CH.EQ.4294967296)GOTO 1100
      IF ((CH.EQ.7918845952.OR.CH.EQ.4429185024.OR.CH.EQ.
     1 KEOC).AND.LABEL(1).EQ.0)
     1GOTO 2700
...
1150  CALL NXTCHR(CH,TY)
      ...
      IF (CH.EQ.7918845952.OR.CH.EQ.4429185024.OR.CH.EQ.
     1 4294967296.OR.CH.EQ.KEOC)GOTO 1180
      GOTO 1140
C
...
C
      IF (ARGCNT.NE.1.OR.(CH.NE.4697620480.AND.CH.NE.818728140
     1 8))GOTO 1190
      ARGTYP=1
      GOTO 1270
C
...
C
      IF (INPBUF(ARGEND-2).NE.5905580032.OR.INPBUF(ARGEND-1).NE.
     1 11811160064.OR.INPBUF(
...
C
1200  IF (INPBUF(ARGEND-2).NE.5502926848.OR.INPBUF(ARGEND-1).NE.
     1 5905580032.OR.INPBUF(
...
C
1230  IF (INPBUF(ARGEND-1).NE.5905580032.OR.INPBUF(ARGEND).NE.
     1 11811160064.OR.ARGCNT.NE.
     12)GOTO 1240
      ARGTYP=6
      GOTO 1270
C
...
C
1240  IF (INPBUF(ARGEND-1).NE.5905580032.OR.INPBUF(ARGEND).NE.
     1 11945377792.OR.ARGCNT.NE.
     12)GOTO 1250
      ARGTYP=7
      GOTO 1270
C
...
1930  IF (CH.EQ.4294967296.OR.CH.EQ.7918845952.OR.CH.EQ.
     1 4429185024.OR.CH.EQ.KEOC)GOTO 2700
...
2000  CALL NXTCHR(CH,TY)
      ...
      IF (CH.NE.4294967296.AND.CH.NE.7918845952.AND.CH.NE.
     1 4429185024.AND.CH.NE.KEOC)
     1GOTO 2450
      GOTO 2040
...
2140  CALL NXTCHR(CH,TY)
      ...
      CALL PACK(LABEL(1),CH)
      GOTO 2140
2150  IF (CH.NE.4294967296.AND.CH.NE.7918845952.AND.CH.NE.
     1 4429185024.AND.CH.NE.KEOC)
     1GOTO 2450
...
2240  CALL NXTCHR(CH,TY)
      ...
      CALL PACK(GO2LBL(1),CH)
      GOTO 2240
2250  IF (CH.NE.4294967296.AND.CH.NE.7918845952.AND.CH.NE.
     1 4429185024.AND.CH.NE.KEOC)
     1GOTO 2450
      GOTO 2700
C
...
2400  I=J
      ...
      IF (CH.EQ.7918845952.OR.CH.EQ.4294967296.OR.CH.EQ.
     1 4429185024.OR.CH.EQ.KEOC)GOTO 2420
2410  FLAGMC=0
      GOTO 2450
...
2570  CALL NXTCHR(CH,TY)
      ...
      IF (CH.NE.5905580032.AND.CH.NE.4294967296.AND.CH.NE.
     1 4429185024.AND.CH.NE.7918845952.AND.CH.NE
     1.KEOC)GOTO 2570
